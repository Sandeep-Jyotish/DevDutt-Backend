...
module.exports = {
        ...
        if (user) {
          ...
          if (isPwdMatch) {
            ...
            if (token) {
              ...
              let update = await Admin.updateOne(user.id).set({
                authToken: token,
              ...
              return res.ok({
                ...
                data: update,
                message: GetMessages("Admin.LoggedinSuccessfully", lang),
              ...
              return res.badRequest({
                status: ResponseCodes.BAD_REQUEST,
                data: {},
                message: GetMessages("Admin.AuthTokenError", lang),
                error: "",
              });
            }
          } else {
            ...
            return res.badRequest({
              status: ResponseCodes.BAD_REQUEST,
              data: {},
              message: GetMessages("Admin.WrongPassword", lang),
              error: "",
            });
          }
        } else {
          ...
          return res.badRequest({
            status: ResponseCodes.BAD_REQUEST,
            data: {},
            message: GetMessages("Admin.NotFound", lang),
            error: "",
          });
        }
      }
  ...
  /**
   * @description This method will set Auth Token as null of the admin at database
   * @method POST
   * @param {Request} req
   * @param {Response} res
   * @returns HTTP Response
    ...
    try {
      ...
      if (update) {
        ...
        return res.ok({
          status: ResponseCodes.OK,
          data: {},
          message: `${update.firstName},` + GetMessages("Admin.LogOut", lang),
          error: "",
        });
      } else {
        //return error
